 ...
 */
gecui.WorkspaceFormPanel = function(config) {
	gecui.WorkspaceFormPanel.superclass.constructor.call(this, Ext.apply( {
		frame : true,
		defaults : {
			anchor : '95%'
		},
...
gecui.WorkspaceFormPanel.Load = Ext.extend(Ext.form.Action.Load, {
...
Ext.extend(gecui.WorkspaceFormPanel, Ext.form.FormPanel, {
	load : function(options) {
		this.form.doAction(new gecui.WorkspaceFormPanel.Load(this.form, options), options);
	}
});

Ext.reg('gecui-workspaceFormPanel', gecui.WorkspaceFormPanel);
